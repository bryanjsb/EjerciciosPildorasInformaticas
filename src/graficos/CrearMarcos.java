...
final class miMarco extends JFrame{
 ...
 // es la opcion cuando le damos click al x de la ventana, para que la aplicacion termine
    ...
    public void cofigurarVentana(){
         /*
    setLocation(x,y); puede configurar la posicion del marco
    setBounds(x,y,ancho,largo); puede configurar la poscion del marco, como tambien el ancho y largo del mismo
    setIconImage(Image imagen);
    setTitle(String titulo);
    seResizable(boolean resisable);
    */
       ...
       // setBounds(250,100,800,600);// este metodo es similiar al usar setSize y setLocation juntos
    ...
    public void laminaTexto(){
        ...
        {// clase interna
            @Override// metdo viene de la clase component
